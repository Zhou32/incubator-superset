...
# under the License.
"""add team_id col to SolarBISlice

Revision ID: c6723e8fcea3
Revises: d09087b1a037
Create Date: 2019-10-07 16:16:40.755053

"""

# revision identifiers, used by Alembic.
revision = 'c6723e8fcea3'
down_revision = 'd09087b1a037'
...
def upgrade():
    ...
    #            existing_type=sa.DATETIME(),
    #            nullable=True)
    op.add_column('solarbi_slices', sa.Column('team_id', sa.Integer(), nullable=True))
...
def downgrade():
    ...
    #            existing_type=sa.DATETIME(),
    #            nullable=False)
    op.drop_column('solarbi_slices', 'team_id')
    # op.alter_column('slices', 'created_on',
    #            existing_type=sa.DATETIME(),
    #            nullable=False)
    # op.alter_column('slices', 'changed_on',
