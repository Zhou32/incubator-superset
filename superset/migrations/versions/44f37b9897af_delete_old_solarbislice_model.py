...
# under the License.
"""Delete old SolarBISlice model

Revision ID: 44f37b9897af
Revises: 7854c375f7c5
Create Date: 2019-09-25 14:58:10.249171

"""

# revision identifiers, used by Alembic.
revision = '44f37b9897af'
down_revision = '7854c375f7c5'
...
def downgrade():
    ...
    sa.Column('slice_name', sa.VARCHAR(length=250), nullable=True),
    ...
    sa.Column('resolution', sa.VARCHAR(length=200), nullable=True),
    sa.Column('query_status', sa.VARCHAR(length=200), nullable=True),
    sa.Column('valid_date', sa.DATETIME(), nullable=True),
    sa.Column('cache_timeout', sa.INTEGER(), nullable=True),
    sa.Column('description', sa.TEXT(), nullable=True),
    sa.Column('params', sa.TEXT(), nullable=True),
    sa.Column('perm', sa.VARCHAR(length=1000), nullable=True),
