...
from superset.solar.security import CustomSecurityManager
...
SQLALCHEMY_DATABASE_URI = 'postgresql://postgres:solarbidb@solarbi-db-dev.cluster-cfye6soa6myy.ap-southeast-2.rds.amazonaws.com:5432/solarbi'
...
WTF_CSRF_EXEMPT_LIST = ["superset.views.core.log", 'superset.views.core.webhook']
...
RECAPTCHA_PUBLIC_KEY = '6LfkdoEUAAAAABhKgDekc0LvM_w8oAP9cdaYe3VE'
RECAPTCHA_PRIVATE_KEY = '6LfkdoEUAAAAAOEGECGPA0BwBhVoxDSCyJUifWGi'
...
# method note: index option should not be overridden
CSV_EXPORT = {
    'encoding': 'utf-8',
}
...
MAPBOX_API_KEY = os.environ.get('pk.eyJ1IjoiZHJ1bmtlbjIwMDIiLCJhIjoiY2ptdTh5e\
                                 HpqMm04ZjNxb2VqNzYyaWQ0OCJ9.md1F6GzpNbgiN_b8F\
                                 ze0NA', 'pk.eyJ1IjoiZHJ1bmtlbjIwMDIiLCJhIjoiY\
                                 2ptdTh5eHpqMm04ZjNxb2VqNzYyaWQ0OCJ9.md1F6GzpN\
                                 bgiN_b8Fze0NA')
