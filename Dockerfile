...
USER superset
ENTRYPOINT /entrypoint.sh $SMTP_USERNAME $SMTP_PASSWORD $STRIPE_SK $STRIPE_PK $MYSQL_USER $MYSQL_PASSWORD $MYSQL_HOST $MYSQL_PORT $MYSQL_DB $SG_API_KEY $VERSION $FREE_CREDIT_DOLLAR
